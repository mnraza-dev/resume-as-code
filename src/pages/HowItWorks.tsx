    ...
    <div className="max-w-6xl mx-auto mt-16 px-4 p-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {steps.map((step, i) => (
          ...
          >
            <Card
              className="rounded-2xl transition-transform transform hover:scale-[1.02] border border-border 
              bg-gradient-to-br from-muted/50 to-background hover:shadow-lg 
